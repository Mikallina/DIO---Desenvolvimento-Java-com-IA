...
public class Operacoes {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Operacoes window = new Operacoes(cliente);
	 ...
	 */
	public Operacoes(CadastroCliente cliente) {
	...
	private void initialize() {
        ...
        btnDepositar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                extrato.adicionarTransacao(obterData(), 0.0, valorDeposito, contaCorrente.getSaldo(), "Depósito realizado");
        ...
        btnSacar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (contaCorrente.getSaldo() >= valorSaque) {
                    ...
                    extrato.adicionarTransacao(obterData(), valorSaque, 0.0, contaCorrente.getSaldo(), "Saque realizado");
        ...
        btnTransferir.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (contaCorrente.getSaldo() >= valorTransferencia) {
                    ...
                    extrato.adicionarTransacao(obterData(), valorTransferencia, valorTransferencia, contaCorrente.getSaldo(), "Transferência realizada");
